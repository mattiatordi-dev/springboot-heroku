...
<div class="mb-3" style="text-align:center;">
  <button onclick="myFunction()" type="button" class="btn btn-danger">Ricerca per nome</button><br>
</div><hr>
<form th:action="@{/searchBook}" method="get" id="myDIV" style="margin-left:auto; margin-right:auto;text-align:center;width:20%;display:none;">
